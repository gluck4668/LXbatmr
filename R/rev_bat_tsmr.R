...
write.xlsx(Rev_mr_result_all,paste0(dir_file,"/",exp_data_file,"___exposure_revmr_all .xlsx"))

if(nrow(Rev_mr_result_significant)>0){
   write.xlsx(Rev_mr_result_significant,paste0(dir_file,"/",exp_data_file,"___exposure_revmr_significant.xlsx")) }
