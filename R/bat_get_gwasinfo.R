...
if(!is.na(data_dir)){
  write.xlsx(gwas_data_info,paste0(dir_file,"/",data_dir," (gwas_id_info).xlsx"))
} else{
write.xlsx(id_list, paste0(dir_file,"/bat_mr_result_significant_info.xlsx"))
write.xlsx(gwas_data_info,paste0(dir_file,"/gwas_data_info.xlsx"))
}
