...
if(!is.na(data_dir)){
  write.xlsx(gwas_data_info,paste0(dir_file,"/",data_dir,"___gwas_id_info.xlsx"))
} else{
write.xlsx(id_list, paste0(dir_file,"/",data_list,"___info.xlsx"))
write.xlsx(gwas_data_info,paste0(dir_file,"/",data_list,"___gwas_info.xlsx"))
}
