...
write.xlsx(mr_result_all,paste0(dir_file,"/",out_data_file,"___outcome_mr_all.xlsx"))

if(nrow(mr_result_significant)>0){
write.xlsx(mr_result_significant,paste0(dir_file,"/",out_data_file,"___outcome_mr_significant.xlsx"))}
