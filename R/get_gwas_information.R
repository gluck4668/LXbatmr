...
#------------------------
dir_file = paste0("gwas catalog information ",Sys.Date())
...
file_name <- str_extract(data_list, "[^/]*(?=\\.xlsx$)")
write.xlsx(gwas_data_info,paste0(dir_file,"/",file_name,"_excel_file_gwas_info.xlsx"))
}

message(paste0("The information of the gwas id can be found in the folder of '",dir_file,"' "))
#----the end----------
}
